...
{
    public abstract class SketAuthenticationProvider : AuthenticationStateProvider, IDisposable
    {
        private readonly SketSettings _sketSettings;
        private readonly ILocalStorageService _localstorage;
        private readonly SketAccessTokenRepository<SketAccessTokenModel> _accessToken;
        public CancellationToken CancellationToken { get; set; }


        public SketAuthenticationProvider(SketSettings sketSettings, ILocalStorageService localstorage, SketAccessTokenRepository<SketAccessTokenModel> accessToken)
        {
            _sketSettings = sketSettings;
